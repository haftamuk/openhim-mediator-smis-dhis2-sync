 ...
 */
router.use('/sync/:agregation-flag/:dx/:ou/:pe', async function (req, res, next) {
...
router.get('/sync/:agregation-flag/:dx/:ou/:pe', function (req, res) {
  ...
  const agregationFlag = req.params.agregation - flag
