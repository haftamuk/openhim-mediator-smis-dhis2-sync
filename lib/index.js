...
function setupApp () {
  const app = express()
  /***
   * Routes for user trigered requests to sync a single KPI
   */
  app.use('/kpi', require('./routes/smis-sync.js'))

  /***
   * TO-DO -
   * Routes to get basic information of KPI from SMIS and DHIS2 for coomparison perposes
   */
  app.use('/dhis2', require('./routes/dhis2.js'))
  app.use('/smis', require('./routes/smis.js'))
